...
![3D Episodes labeling interface](../../.gitbook/assets/3d_episodes_interface.png)
...
Main idea of `key` fields and `id` you can see below in [Key id map file](07_Supervisely_format_pointcloud_episode.md#key-id-map-file) section.
...
You can avoid using key-id-map directly with API and SDK to create your own file structure. An example will be shown below in the [SDK section](07_Supervisely_format_pointcloud_episode.md#sdk).
