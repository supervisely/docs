...
Sometimes, you have too many files to upload via drag-and-drop. Or, you may want to upload files via the API first, and then run a Supervisely App on those files. Or, maybe, you launched a Supervisely App that generated a new project, saved it to your [team files](../../team-files/), but those files are not a project yet. In that case, you can just select the appropriate Supervisely App from the context menu of a folder in your [Team Files](../../team-files/) — and enjoy.

![](../../../.gitbook/assets/apps-teamfiles.png)
