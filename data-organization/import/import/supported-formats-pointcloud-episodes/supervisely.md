...
**Optional fields**
These fields are optional and are not needed when uploading the project.
...
- <a href="../../../Annotation-JSON-format/07_Supervisely_format_pointcloud_episode.md" target="_blank">Supervisely Pointcloud Episodes Annotation</a>
