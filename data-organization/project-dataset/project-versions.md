...
- **During creation:** Check the **Enable Preview** flag when creating a new version to automatically generate a read-only project snapshot accessible in the well-known UI.
